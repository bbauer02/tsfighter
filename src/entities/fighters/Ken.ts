...
import {FighterState, FrameDelay, PushBox} from "../../constants/fighter.ts";
export class Ken extends Fighter {
    constructor(playerId: number) {
        ...
        this.frames = new Map([
            ...
            ['forwards-2', [[70, 864, 60, 88], [35,86], PushBox.IDLE]],
            ...
            ['jump-roll-6', [[1664, 976, 71, 88], [53,98], PushBox.JUMP]],
            ...
            ['med-punch-2', [[650, 1148, 74, 95],  [28, 92], PushBox.IDLE]],
            ['med-punch-3', [ [736, 1148, 108, 94],  [28, 92], PushBox.IDLE]],
            ...
            ['light-kick-2', [ [143, 1565, 114, 92], [68, 95], PushBox.IDLE]],

            // Med KICK
            ['med-kick-1', [ [143, 1565, 114, 92],  [68, 95], PushBox.IDLE]],
